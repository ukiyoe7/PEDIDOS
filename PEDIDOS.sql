...
SELECT 
    ...
    CASE 
        ...
        WHEN P.TPCODIGO IN (11) THEN 
            CASE 
                WHEN LEFT(CHAVE,2) IN ('LA','LS') THEN 'ATACADO 11 LA'
                ELSE 'ATACADO 11 BLOCO'
            END
        WHEN P.TPCODIGO IN (15) THEN 'ATACADO 15' 
        WHEN P.TPCODIGO IN (1) THEN 
            CASE 
                WHEN LEFT(CHAVE,2) IN ('LA','LS') THEN 'ATACADO 1 LA'
                ELSE 'ATACADO 1 BLOCO' 
            END
        WHEN P.TPCODIGO IN (12) THEN 
            CASE 
                WHEN LEFT(CHAVE,2) IN ('LA','LS') THEN '12 LA'
                ELSE '12 SURF' 
            END
